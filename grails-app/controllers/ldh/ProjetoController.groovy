...
class ProjetoController {
    ...
    def save(Projeto projetoInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.created.message', args: [message(code: 'projetoInstance.label', default: 'Projeto'), projetoInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'projetoInstance.label', default: 'Projeto'), params.id])
                redirect action: "index", method: "GET"
            }
